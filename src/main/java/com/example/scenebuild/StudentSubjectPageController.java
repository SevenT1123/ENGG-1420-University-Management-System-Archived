...
import university.SubjectManager;
...
public class StudentSubjectPageController implements Initializable {
    ...
    private void loadSubjectsIntoTable() {
        ...
        subjectTable.setItems(masterSubjectList); // Show everything initially
    }
